	...
	public static cars: any = [
		{
			...
			'color': '56 Roberta Crescent',
			'price': 165956,
			'condition': 'copper@gmail.com',
			...
			'color': '3 Gateman Street',
			'price': 196247,
			'condition': 'mark@gmail.com',
